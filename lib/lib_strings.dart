...
abstract class LibStrings {
  ...
  static const String lib_exception_ApiResponseNoNetwork = 'lib_exception_ApiResponseNoNetwork';
  static const String lib_exception_ApiResponseInvalidException = 'lib_exception_ApiResponseInvalidException';
  static const String lib_exception_ApiResourceNotFoundException = 'lib_exception_ApiResourceNotFoundException';
  static const String lib_exception_ApiResourceAlreadyExistsException = 'lib_exception_ApiResourceAlreadyExistsException';
  static const String lib_exception_ApiNotImplementedException = 'lib_exception_ApiNotImplementedException';
  static const String lib_exception_ApiBadRequestException = 'lib_exception_ApiBadRequestException';
  static const String lib_exception_ApiForbiddenException = 'lib_exception_ApiForbiddenException';
  static const String lib_exception_ApiInternalServerErrorException = 'lib_exception_ApiInternalServerErrorException';
  ...
  static const List<String> allKeys = [
    ...
    'lib_general_actionNext',
    'lib_general_actionBack',
    'lib_general_actionComplete',
    'lib_general_actionCancel',
    'lib_general_actionSave',
    'lib_general_actionRetry',
    'lib_general_actionConfirm',
    'lib_general_actionDismiss',
    'lib_general_actionClose',
    'lib_general_actionOkay',
    'lib_general_actionYes',
    'lib_general_actionNo',
    'lib_general_actionSend',
    'lib_general_actionDelete',
    'lib_general_actionEdit',
    'lib_general_actionAdd',
    'lib_general_actionSubmit',
    'lib_general_actionRemove',
    'lib_general_actionSelect',
    'lib_general_actionChoose',
    'lib_general_actionDeviceSettings',
    'lib_general_titleError',
    'lib_general_titleInfo',
    'lib_general_titleWarning',
    'lib_general_titleSuccess',
    'lib_general_titleConfirm',
    'lib_general_titleCongratulation',
    'lib_commonDialogs_permissionDeniedCamera_title',
    'lib_commonDialogs_permissionDeniedCamera_message',
    'lib_commonDialogs_permissionDeniedGallery_title',
    'lib_commonDialogs_permissionDeniedGallery_message',
    'lib_lists_noItemsFound',
    'lib_lists_noMoreItems',
    'lib_lists_loadingMoreItemsFailed',
    'lib_error_network',
    'lib_error_unknown',
    'lib_warning_resourceNotFound_title',
    'lib_warning_resourceNotFound_message',
    'lib_imageNotAvailable_message',
    'lib_models_cognitoSignIn_invalidCredentials_message',
    'lib_models_cognitoSignIn_passwordChangeRequired_message',
    'lib_models_cognitoChangeInitialPassword_unauthorized_message',
    'lib_models_cognitoChangeInitialPassword_passwordTooShort_message',
    'lib_models_cognitoChangeInitialPassword_passwordUpperMissing_message',
    'lib_models_cognitoChangeInitialPassword_passwordLowerMissing_message',
    'lib_models_cognitoChangeInitialPassword_passwordNumberMissing_message',
    'lib_models_cognitoChangeInitialPassword_passwordSymbolMissing_message',
    'lib_models_cognitoForgotPasswordRequest_userNotFound_message',
    'lib_models_cognitoForgotPasswordRequest_sendLimitExceeded_message',
    ...
    'lib_blueForms_formInputImages_changeImage',
    'lib_blueForms_formInputImagesSingle_errorRequired',
    'lib_blueForms_formInputImagesSingle_errorMinWidth',
    'lib_blueForms_formInputImagesSingle_errorMinHeight',
    'lib_blueForms_inputValidators_failedOptionSelectionUntouched',
    'lib_blueForms_inputValidators_failedNotEmptyCheck',
    'lib_blueForms_inputValidators_failedPhoneNumberCheck',
    'lib_blueForms_inputPickOption_pleaseChoose',
    'lib_blueForms_requiredFieldsNotice',
    'lib_blueForms_commonInputs_emailLabel',
    'lib_blueForms_commonInputs_emailHint',
    'lib_blueForms_commonInputs_passwordLabel',
    'lib_blueForms_commonInputs_passwordHint',
    'lib_blueForms_commonInputs_phoneNumberLabel',
    'lib_blueForms_commonInputs_phoneNumberHint',
    'lib_blueForms_commonInputs_givenNameLabel',
    'lib_blueForms_commonInputs_givenNameHint',
    'lib_blueForms_commonInputs_familyNameLabel',
    'lib_blueForms_commonInputs_familyNameHint',
    'lib_blueForms_commonInputs_address_streetLabel',
    'lib_blueForms_commonInputs_address_streetHint',
    'lib_blueForms_commonInputs_address_postalCodeLabel',
    'lib_blueForms_commonInputs_address_postalCodeHint',
    'lib_blueForms_commonInputs_address_cityLabel',
    'lib_blueForms_commonInputs_address_cityHint',
    'lib_exception_ApiResponseNoNetwork',
    'lib_exception_ApiResponseInvalidException',
    'lib_exception_ApiResourceNotFoundException',
    'lib_exception_ApiResourceAlreadyExistsException',
    'lib_exception_ApiNotImplementedException',
    'lib_exception_ApiBadRequestException',
    'lib_exception_ApiForbiddenException',
    'lib_exception_ApiInternalServerErrorException',
